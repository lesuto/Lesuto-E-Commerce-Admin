...
import { MarketplaceResolver } from './api/marketplace.resolver'; // Ensure path matches your structure
import { marketplaceSchema } from './api/marketplace.schema';     // Ensure path matches your structure
...
@VendurePlugin({
    ...
    configuration: config => {
        // Optional: Add custom permissions if needed
